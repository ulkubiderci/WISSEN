    ...
    public class EverNoteUserManager
    {
        ...
        public BusinessLayerResult<EverNoteUser> RegisterUser(RegisterViewModal data)
        {
            ...
            else
            {
                ...
                if (dbResult > 0)
                {
                    ...
                    MailHelper.SendMail(body, res.Result.Email, "myevernote user manager hesap aktifleştirme");
        ...
        public BusinessLayerResult<EverNoteUser>ActivateUser(Guid activateId)
        {
            ...
            if(res.Result!=null)
            {
                ...
                {
                    res.AddError(ErrorMessageCode.UserNameAlreadyExist, "Kullanıcı zaten aktif edilmiş");
                    return res;
